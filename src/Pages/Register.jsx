        ...
        <div className="form_main">
          ...
          <form action="" className="form-box">
              <div className="form-inner">
                  ...
                  <div className="form-inputs">
                      ...
                      <div className="radio">
                          ...
                          <label forhtml="radio-1" className="radio-label">
                              <span>
                                  I'm attracted in receiving marketing emails for updates on upcoming promotions,
                  ...
                  <button className="btn btn-primary btn-lg px-4 me-md-2">Register Now</button>
                  <div className="have_account">
                      Have an account? <Link to="/login"> Register Now </Link>
                  </div>
              </div>
          </form>
        </div>
