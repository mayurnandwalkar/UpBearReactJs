        ...
        <section className="signup_section form_section">
            ...
            <form action="" className="form-box">
                <div className="form-inner">
                    ...
                    <div className="form-inputs">
                        ...
                        <div className="radio">
                            ...
                            <label forhtml="radio-1" className="radio-label">
                                <span>
                                I am interested in receiving marketing emails with information about upcoming promotions, events, and new feature updates
                                </span>
                            </label>
                        </div>
                        <div className="radio">
                    ...
                    <button className="btn btn-primary btn-lg px-4 me-md-2" onClick={HandleCreateAccountButton}>Register Now</button>
